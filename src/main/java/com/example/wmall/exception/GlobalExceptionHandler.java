...
public class GlobalExceptionHandler {
     ...
     * 业务异常处理
     */
    @ExceptionHandler(com.example.wmall.exception.BusinessException.class)
    public Result<?> handleBusinessException(com.example.wmall.exception.BusinessException e) {
